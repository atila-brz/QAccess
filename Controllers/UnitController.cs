...
namespace QAccess.Controllers
{
    public class UnitController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("UnitId,Tower,Block,Number,Country,State,City,Road,Cep,Complement")] Unit unit)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("UnitId,Tower,Block,Number,Country,State,City,Road,Cep,Complement")] Unit unit)
        {
            if (id != unit.UnitId)
            {
                return NotFound();
